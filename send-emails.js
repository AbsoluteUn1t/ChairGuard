...
async function sendAll() {
    ...
    for (const email of emails) {
        try {
            ...
            console.log(`✓ ${email.business} -> ${email.to}`);
            sent++;
        } catch (err) {
            console.log(`✗ ${email.business} -> ${email.to} [${err.message}]`);
        }
    }
    
    console.log(`\n${sent}/${emails.length} sent successfully`);
}
